...
ImageButton.Image = "rbxassetid://16133592390"
...
--------------------------------------------------------------------
local Library = Update:Window("kaigm","")
------------------------------------------
...
Setting:Label("SCRIPT FEEE")

Setting:Line()

Setting:Button("LINK DISCORD",function()
 
 setclipboard("https://discord.com/invite/QypYvJ3TBc")
  DiscordLib:Notification("Thông Báo" Update mới nhất đc thông báo tại discord" , 10 ,11816162894 )
 end)
